...
reemplazos <- function(upm,numero,antes,mes,fecha,variable,año,mes_g){
        ...
        saveRDS(conglom_selec,
                    paste0("./Output/4.Reemplazos/",año,"/",mes,"/",numero,"/conglomerados_seleccionados_2023.rds"))
        ...
        rotacion_paneles = readRDS("./bases/insumo reemplazos/rotacion_paneles_ENEMDU_2021_2024.rds")
...
base.antes <- read_excel(paste0("./Output/4.Reemplazos/",año,"/",mes,"/",antes,"/muestra_",mes_g,".xlsx"))
...
mes <- c("3.Marzo")
fecha <- c("20240322_2")
variable = c("enemdu_24_03_f")
año = c("4. 2024")
mes_g = c("marzo")


##Verifiar
# ifelse(marco[marco$id_upm==upm,]$seleccionable==0,
#        "ALERTA: ESTE CONGLOMERADO YA FUE REEMPLAZADO","OK")
